...
#pragma warning restore 649
        ...
        [Tooltip("Health stats"), SerializeField]
        ...
        private void Start()
        {
            ...
            sensSlider.value = PlayerPrefs.GetFloat("MouseSens", mouseSensitivity);
        }
        ...
        //Sets mouse sensitivity valuse based on slider position
        ...
        {
            if (other.gameObject.tag == "Arm" && isHit == false)
            {
                TakeDamage(10);
                isHit = true;
            }
        ...
        private void Update()
        {
            ...
            Jump();
            PlayFootstepSounds();
            if (regenCountdown > 0 && isHit == true)
            {
                regenCountdown -= Time.deltaTime;
            }
            else if (regenCountdown <= 0 && isHit == true)
            {
                isHit = false;
                regenCountdown = regenTimer;
            }
